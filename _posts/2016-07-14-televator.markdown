...
{% highlight ruby %}
  ...
  447 ?        Ssl    0:04 /usr/sbin/NetworkManager --no-daemon
  ...
  600 tty7     Ss+    0:10 /usr/lib/xorg/Xorg -core :0 -seat seat0 -auth /var/run/lightdm/root/:0 -nolisten tcp vt7 -novtswitch
