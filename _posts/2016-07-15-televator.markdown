...
Eu estou ligado ininterruptamente à 11 hours, 5 minutes !!!

Script de monitoramento executado em - Fri Jul 15 06:00:21 AMT 2016 <br />
...
{% highlight ruby %}
  ...
  415 ?        Ssl    0:03 /usr/bin/whoopsie -f
  ...
  447 ?        Ss     0:03 /usr/bin/dbus-daemon --system --address=systemd: --nofork --nopidfile --systemd-activation
  489 ?        Ssl    0:00 /usr/sbin/cups-browsed
  490 ?        Ssl    0:18 /usr/sbin/NetworkManager --no-daemon
  580 ?        Ss     0:00 /usr/sbin/sshd -D
  588 ?        Ssl    0:01 /usr/lib/policykit-1/polkitd --no-debug
  598 ?        Ssl    0:00 /usr/sbin/lightdm
  617 tty7     Ss+    0:16 /usr/lib/xorg/Xorg -core :0 -seat seat0 -auth /var/run/lightdm/root/:0 -nolisten tcp vt7 -novtswitch
  646 tty1     Ss+    0:00 /sbin/agetty --noclear tty1 linux
  647 ttyS0    Ss+    0:00 /sbin/agetty --keep-baud 115200 38400 9600 ttyS0 vt220
  649 ?        Ssl    0:05 /usr/sbin/ntpd -p /var/run/ntpd.pid -g -u 119:125
 ...
 1044 ?        Sl     0:02 /usr/lib/mate-panel/clock-applet
 ...
 1111 ?        S      0:11 [kworker/2:0]
 1113 ?        S      0:34 [kworker/1:1]
...
11179 ?        S      0:01 [kworker/0:0]
29369 ?        S      0:00 [kworker/0:1]
29995 ?        S      0:00 [kworker/0:2]
30153 ?        S      0:00 /usr/sbin/CRON -f
30154 ?        Ss     0:00 /bin/sh -c mastershell.sh
30155 ?        S      0:00 /bin/bash /bin/mastershell.sh
30255 ?        S      0:00 sh /home/odroid/rodolfo/odroid-br.github.io/_scripts/odroid-monitor.sh
30295 ?        R      0:00 ps ax
{% endhighlight %}
