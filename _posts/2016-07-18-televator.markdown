...
{% highlight ruby %}
  ...
  617 tty7     Ss+    1:16 /usr/lib/xorg/Xorg -core :0 -seat seat0 -auth /var/run/lightdm/root/:0 -nolisten tcp vt7 -novtswitch
  646 tty1     Ss+    0:00 /sbin/agetty --noclear tty1 linux
  647 ttyS0    Ss+    0:00 /sbin/agetty --keep-baud 115200 38400 9600 ttyS0 vt220
  649 ?        Ssl    0:42 /usr/sbin/ntpd -p /var/run/ntpd.pid -g -u 119:125
  ...
  863 ?        Sl     0:06 /usr/bin/mate-settings-daemon
  ...
  908 ?        Sl     0:05 /usr/lib/aarch64-linux-gnu/deja-dup/deja-dup-monitor
  909 ?        Sl     0:01 /usr/bin/python3 /usr/share/system-config-printer/applet.py
  932 ?        Sl     0:28 nm-applet
  933 ?        Sl     0:01 tilda
