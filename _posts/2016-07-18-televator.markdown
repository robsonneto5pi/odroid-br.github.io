...
{% highlight ruby %}
  ...
  464 ?        Ssl    0:06 /usr/sbin/NetworkManager --no-daemon
  ...
  624 tty7     Ss+    0:13 /usr/lib/xorg/Xorg -core :0 -seat seat0 -auth /var/run/lightdm/root/:0 -nolisten tcp vt7 -novtswitch
